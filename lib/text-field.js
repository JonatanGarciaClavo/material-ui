...
var TextField = React.createClass({
  ...
  statics: {
    getRelevantContextKeys: function getRelevantContextKeys(muiTheme) {
      var textFieldTheme = this.state.muiTheme.textField;
  ...
  getStyles: function getStyles() {
    ...
    var _getRelevantContextKeys = this.getRelevantContextKeys(this.state.muiTheme);

    var floatingLabelColor = _getRelevantContextKeys.floatingLabelColor;
    var focusColor = _getRelevantContextKeys.focusColor;
    var borderColor = _getRelevantContextKeys.borderColor;
    var textColor = _getRelevantContextKeys.textColor;
    var disabledTextColor = _getRelevantContextKeys.disabledTextColor;
    var backgroundColor = _getRelevantContextKeys.backgroundColor;
    var hintColor = _getRelevantContextKeys.hintColor;
    var errorColor = _getRelevantContextKeys.errorColor;
    var isRtl = _getRelevantContextKeys.isRtl;
